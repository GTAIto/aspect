...
for s = 1:nsteps
    ...
    if isfinite(x_channel)
        ...
        [gen_below(s), area_sl] = integrate_left_of_streamline(x, y, conn, carea, dmdt_c, sl);
    else
        flux_top(s)  = 0;
        area_sl      = 0;
...
%% ==========================================================================
function [gen, area_left] = integrate_left_of_streamline(x, y, conn, carea, dmdt_c, sl)
% Integrate dmdt_c over all area to the left of the streamline.
% Returns gen (integral of dmdt_c weighted by area) and area_left (total
% area to the left of the streamline, in m^2).
%
